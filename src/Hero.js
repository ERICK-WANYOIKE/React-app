        ...
        <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
          <div className="flex flex-col mb-16 sm:text-center sm:mb-0">
            <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
              ...
              <p className="text-sm font-cursive  text-gray-200 md:text-base">
           ...
           <div>
           <ReactLink className="inline-flex rounded-full items-center justify-center h-12 px-6 font-semibold
            rounded-full text-white py-2 px-3 bg-red-600 hover:bg-red-700" to="/get started">
            Get started
            </ReactLink>
           </div>
          </div>
