      ...
      <div className="grid gap-4 row-gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col justify-between p-5 border rounded shadow-sm">
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Global supply chain expertise </h6>
        ...
        <div className="flex flex-col justify-between p-5 border rounded shadow-sm">
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Emerging markets</h6>
            <p className="mb-3 text-sm text-gray-900">
        ...
        <div className="flex flex-col justify-between p-5 border rounded shadow-sm">
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">High-value assets</h6>
            <p className="mb-3 text-sm text-gray-900">
        ...
        <div className="flex flex-col justify-between p-5 border rounded shadow-sm">
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Digital DNA</h6>
            <p className="mb-3 text-sm text-gray-900">
